...
function FormaRegistracija() {
	...
	function handleRegister(e) {
		e.preventDefault();
		axios
			.post('https://localhost:44336/Authentication/register', podaciKorisnika)
			.then((res) => {
		...
		<div>
			<form className="forma" onSubmit={handleRegister}>
				...
				<div className="form-group">
					...
					<p className="passwordHelper">*mora sadržati velika i mala slova, bar jedan broj i znak interpunkcije</p>
					<input
						type="password"
						className="form-control"
				...
				<div className="form-group">
					<label for="formGroupExampleInput4">Broj licne karte</label>
					<input
						type="surname"
						class="form-control"
						id="formGroupExampleInput4"
